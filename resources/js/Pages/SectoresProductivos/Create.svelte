...
<AuthenticatedLayout>
    ...
    <div class="bg-white rounded shadow max-w-3xl">
        <form on:submit|preventDefault={submit}>
            <fieldset class="p-8" disabled={canCreateSectoresProductivos || isSuperAdmin ? undefined : true}>
                <div class="mt-4">
            ...
            <div class="px-8 py-4 bg-gray-100 border-t border-gray-200 flex items-center sticky bottom-0">
                {#if canCreateSectoresProductivos || isSuperAdmin}
                    <LoadingButton loading={sending} class="btn-indigo ml-auto" type="submit">Crear sector productivo</LoadingButton>
                {/if}
            </div>
        </form>
    </div>
