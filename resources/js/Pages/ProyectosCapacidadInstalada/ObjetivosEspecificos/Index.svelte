...
<AuthenticatedLayout>
    ...
    <a use:inertia href={route('proyectos-capacidad-instalada.productos.index', proyectoCapacidadInstalada.id)} class="flex bottom-0 fixed hover:bg-violet-600 mb-4 px-6 py-2 bg-violet-700 rounded-lg shadow-2xl text-center text-white z-50">
