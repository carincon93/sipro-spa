<script>
    ...
    let canDestroyMincienciasSubtypologies =
        authUser.can.find(
    ...
    function destroy() {
        if (canDestroyMincienciasSubtypologies || isSuperAdmin) {
            $form.delete(
                route(
...
<AuthenticatedLayout>
    <header class="shadow bg-white" slot="header">
        ...
        >
            <div>
                <h1>
                    {#if canIndexMincienciasSubtypologies || canShowMincienciasSubtypologies || canEditMincienciasSubtypologies || canDestroyMincienciasSubtypologies || isSuperAdmin}
                        <a
                            use:inertia
