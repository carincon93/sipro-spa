    ...
    <DataTable class="mt-20">
        ...
        <tbody slot="tbody">
            <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                <td class="border-t"><p class="px-6 py-4 focus:text-violet-500">Resumen proyectos</p></td>
                <td class="border-t">
            ...
            <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                <td class="border-t"><p class="px-6 py-4 focus:text-violet-500">Resumen presupuestos y roles SENNOVA</p></td>
                <td>
                    <Select id="convocatorias" items={convocatorias} bind:selectedValue={$form.convocatoria} error={errors.convocatoria} autocomplete="off" placeholder="Seleccione una convocatoria" required />
                </td>
                <td class="border-t td-actions">
            ...
            <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                <td class="border-t">
                    <p class="px-6 py-4 focus:text-violet-500">Evaluaciones</p>
                </td>
                <td class="border-t">
                    <Select id="convocatorias" items={convocatorias} bind:selectedValue={$form.convocatoria} error={errors.convocatoria} autocomplete="off" placeholder="Seleccione una convocatoria" required />
                </td>
            ...
            <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                <td class="border-t"><p class="px-6 py-4 focus:text-violet-500">Resumen presupuesto proyecto aprobado</p></td>
                <td>
                    <Select id="convocatorias" items={convocatorias} bind:selectedValue={$form.convocatoria} error={errors.convocatoria} autocomplete="off" placeholder="Seleccione una convocatoria" required />
                </td>
                <td class="border-t td-actions">
            ...
            <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                <td class="border-t"><p class="px-6 py-4 focus:text-violet-500">Comentarios evaluaciones</p></td>
                <td>
                    <Select id="convocatorias" items={convocatorias} bind:selectedValue={$form.convocatoria} error={errors.convocatoria} autocomplete="off" placeholder="Seleccione una convocatoria" required />
                </td>
                <td class="border-t td-actions">
            ...
            <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                <td class="border-t"><p class="px-6 py-4 focus:text-violet-500">Proyectos TA</p></td>
                <td>
                    <Select id="convocatorias" items={convocatorias} bind:selectedValue={$form.convocatoria} error={errors.convocatoria} autocomplete="off" placeholder="Seleccione una convocatoria" required />
                </td>
                <td class="border-t td-actions">
            ...
            <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                <td class="border-t"><p class="px-6 py-4 focus:text-violet-500">Proyectos I+D+i</p></td>
                <td>
                    <Select id="convocatorias" items={convocatorias} bind:selectedValue={$form.convocatoria} error={errors.convocatoria} autocomplete="off" placeholder="Seleccione una convocatoria" required />
                </td>
                <td class="border-t td-actions">
            ...
            <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                <td class="border-t"><p class="px-6 py-4 focus:text-violet-500">Proyectos TP</p></td>
                <td>
                    <Select id="convocatorias" items={convocatorias} bind:selectedValue={$form.convocatoria} error={errors.convocatoria} autocomplete="off" placeholder="Seleccione una convocatoria" required />
                </td>
                <td class="border-t td-actions">
            ...
            <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                <td class="border-t"><p class="px-6 py-4 focus:text-violet-500">Cultura de innovación</p></td>
                <td>
                    <Select id="convocatorias" items={convocatorias} bind:selectedValue={$form.convocatoria} error={errors.convocatoria} autocomplete="off" placeholder="Seleccione una convocatoria" required />
                </td>
                <td class="border-t td-actions">
            ...
            <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                <td class="border-t"><p class="px-6 py-4 focus:text-violet-500">Proyectos ST</p></td>
                <td>
                    <Select id="convocatorias" items={convocatorias} bind:selectedValue={$form.convocatoria} error={errors.convocatoria} autocomplete="off" placeholder="Seleccione una convocatoria" required />
                </td>
                <td class="border-t td-actions">
            ...
            <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                <td class="border-t">
                    <p class="px-6 py-4 focus:text-violet-500">Proyectos de capacidad instalada</p>
                </td>
                <td />
                <td class="border-t td-actions">
            ...
            <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                <td class="border-t">
                    <p class="px-6 py-4 focus:text-violet-500">Grupos, Líneas y Semilleros de investigación</p>
                </td>
                <td />
                <td class="border-t td-actions">
                    {#if isSuperAdmin || checkRole(authUser, [20, 18, 19, 5, 17])}
