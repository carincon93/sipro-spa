<script>
    ...
    let form = useForm({
        ...
        fecha_incio: projectSennovaBudget.software_info?.fecha_incio,
        fecha_finalizacion:
            projectSennovaBudget.software_info?.fecha_finalizacion,
    })
...
<AuthenticatedLayout>
    <header class="shadow bg-white" slot="header">
        ...
        >
            <div>
                <h1>
                    {#if canIndexProjectSennovaBudgets || canShowProjectSennovaBudgets || canEditProjectSennovaBudgets || canDestroyProjectSennovaBudgets || isSuperAdmin}
                        <a
                            use:inertia
                            href={route(
