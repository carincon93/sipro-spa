                ...
                {#each convocatorias.data as convocatoria (convocatoria.id)}
                    {#if (convocatoria.tipo_convocatoria != 3 && convocatoria.visible) || isSuperAdmin}
                        <div>
                            ...
                            {/if}
                            <a use:inertia href={route('convocatorias.dashboard', convocatoria.id)} class="bg-white overflow-hidden shadow-sm px-6 py-2 hover:bg-violet-500 hover:text-white h-72 flex justify-center items-center flex-col">
