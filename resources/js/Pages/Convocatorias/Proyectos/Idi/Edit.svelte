...
<AuthenticatedLayout>
    ...
    <Dialog bind:open={proyectoDialogOpen} id="informacion">
        ...
        <div slot="content">
            <div>
                {#if JSON.parse(idi.proyecto.estado_cord_sennova)?.requiereSubsanar == true || JSON.parse(idi.proyecto.estado)?.requiereSubsanar == true}
                ...
                {:else if JSON.parse(idi.proyecto.estado_cord_sennova)?.requiereSubsanar == false || JSON.parse(idi.proyecto.estado)?.requiereSubsanar == false}
                    <div>
