...
<AuthenticatedLayout>
    ...
    <Dialog bind:open={proyectoDialogOpen} id="informacion">
        ...
        <div slot="content">
            <div>
                {#if (JSON.parse(idi.proyecto.estado_cord_sennova)?.requiereSubsanar == true && convocatoria.fase == 3) || (JSON.parse(idi.proyecto.estado)?.requiereSubsanar == true && convocatoria.fase == 3)}
                ...
                {:else if (JSON.parse(idi.proyecto.estado_cord_sennova)?.requiereSubsanar == false && convocatoria.fase == 3) || (JSON.parse(idi.proyecto.estado)?.requiereSubsanar == false && convocatoria.fase == 3)}
                    <div>
