...
<AuthenticatedLayout>
    ...
    <Dialog bind:open={proyectoDialogOpen} id="informacion">
        ...
        <div slot="content">
            <div>
                {#if JSON.parse(tp.proyecto.estado)?.requiereSubsanar == true && tp.proyecto.mostrar_recomendaciones == true}
                ...
                {:else if JSON.parse(tp.proyecto.estado)?.requiereSubsanar == false && tp.proyecto.mostrar_recomendaciones == true}
                    <div>
