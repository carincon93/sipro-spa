...
<AuthenticatedLayout>
    ...
    <Dialog bind:open={proyectoDialogOpen} id="informacion">
        ...
        <div slot="content">
            <div>
                {#if JSON.parse(culturaInnovacion.proyecto.estado)?.requiereSubsanar == true && culturaInnovacion.proyecto.mostrar_recomendaciones == true}
                ...
                {:else if JSON.parse(culturaInnovacion.proyecto.estado)?.requiereSubsanar == false && culturaInnovacion.proyecto.mostrar_recomendaciones == true}
                    <div>
