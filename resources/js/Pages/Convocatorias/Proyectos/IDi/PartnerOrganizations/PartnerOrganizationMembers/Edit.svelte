<script>
    ...
    let canDestroytPartnerOrganizationMembers = authUser.can.find((element) => element == 'partner-organization-members.delete') == 'partner-organization-members.delete'
    ...
    let form = useForm({
        ...
        document_type: {
            ...
            label: documentTypes.find((item) => item.value == partnerOrganizationMember.document_type)?.label,
        },
    ...
    function destroy() {
        if (canDestroytPartnerOrganizationMembers || isSuperAdmin) {
...
<AuthenticatedLayout>
    <header class="shadow bg-white" slot="header">
        <div class="flex items-center justify-between lg:px-8 max-w-7xl mx-auto px-4 py-6 sm:px-6">
            <div>
                <h1>
                    {#if canIndextPartnerOrganizationMembers || canShowtPartnerOrganizationMembers || canEditPartnerOrganizationMembers || canDestroytPartnerOrganizationMembers || isSuperAdmin}
