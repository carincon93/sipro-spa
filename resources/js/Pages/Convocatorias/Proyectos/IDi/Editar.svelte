<script>
    ...
    let requiereJustificacionEconomiaNaranja =
        idi.justificacion_economia_naranja != null
    let requiereJustificacionPoliticaDiscapacidad =
    ...
    let form = useForm({
        ...
        disciplina_subarea_conocimiento_id:
            idi.disciplina_subarea_conocimiento_id,
        ...
        relacionado_plan_tecnologico: {
            ...
            label: OpcionesIDiDropdown.find(
                (item) => item.value == idi.relacionado_plan_tecnologico,
            )?.label,
        },
        relacionado_agendas_competitividad: {
            value: idi.relacionado_agendas_competitividad,
            label: OpcionesIDiDropdown.find(
                (item) => item.value == idi.relacionado_agendas_competitividad,
            )?.label,
        },
        relacionado_mesas_sectoriales: {
            value: idi.relacionado_mesas_sectoriales,
            label: OpcionesIDiDropdown.find(
                (item) => item.value == idi.relacionado_mesas_sectoriales,
            )?.label,
        },
        relacionado_tecnoacademia: {
            value: idi.relacionado_tecnoacademia,
            label: OpcionesIDiDropdown.find(
                (item) => item.value == idi.relacionado_tecnoacademia,
            )?.label,
        },

        tecnoacademia_id: {
            value: tecnoacademia?.id,
            label: tecnoacademias.find(
                (item) => item.value == tecnoacademia?.id,
            )?.label,
        },
    ...
    function submit() {
        if (canEditIDi || isSuperAdmin) {
            ...
            $form.put(
                route('convocatorias.idi.update', [convocatoria.id, idi.id]),
                {
    ...
    function destroy() {
        if (canDestroyIDi || isSuperAdmin) {
            $deleteForm.delete(
                route('convocatorias.idi.destroy', [convocatoria.id, idi.id]),
                {
                    preserveScroll: true,
                },
            )
    ...
    async function getLineasTecnologicas(tecnoacademia) {
        let res = await axios.get(
            route('web-api.tecnoacademias.lineas-tecnologicas', [
                tecnoacademia,
            ]),
        )
        res.status == '200'
            ? ($form.linea_tecnologica_id = lineasTecnologicasRelacionadas)
            : null
...
<AuthenticatedLayout>
    ...
    <form on:submit|preventDefault={submit}>
        <fieldset
            class="p-8"
            disabled={canEditIDi || isSuperAdmin ? undefined : true}
        >
            <div class="mt-28">
                <Label
                    required
                ...
                <Textarea
                    ...
                    classes="bg-transparent block border-0 {errors.titulo
                        ? ''
            ...
            <div class="mt-44 grid grid-cols-2">
                ...
                <div>
                    <DynamicList
                        id="tipo_proyecto_id"
                        bind:value={$form.tipo_proyecto_id}
                        routeWebApi={route('web-api.tipos-proyecto', 2)}
                        classes="min-h"
                        placeholder="Busque por el nombre de la dependencia presupuestal, línea programática"
                        message={errors.tipo_proyecto_id}
                        required
                    />
                </div>
            </div>
            <div class="mt-44 grid grid-cols-2">
                ...
                <div>
                    <DynamicList
                        ...
                        routeWebApi={route('web-api.redes-conocimiento')}
                        classes="min-h"
            ...
            <div class="mt-44 grid grid-cols-2">
                ...
                <div>
                    <DynamicList
                        ...
                        routeWebApi={route(
                            'web-api.disciplinas-subarea-conocimiento',
                        )}
                        classes="min-h"
            ...
            <div class="mt-44 grid grid-cols-2">
                ...
                <div>
                    <DynamicList
                        ...
                        routeWebApi={route('web-api.actividades-economicas')}
            ...
            <div class="mt-44 grid grid-cols-2">
                ...
                <div>
                    <DynamicList
                        ...
                        routeWebApi={route('web-api.tematicas-estrategicas')}
                ...
                <div>
                    ...
                    {#if tieneVideo}
                        ...
                        <Input
                            ...
                            required={!tieneVideo ? undefined : 'required'}
                        />
                    {/if}
                </div>
            </div>
            ...
            <div class="mt-44 grid grid-cols-2">
                ...
                <div>
                    <div class="flex items-center mb-14">
                        <Switch
                            bind:checked={requiereJustificacionIndustria4}
                        />
                    </div>
                    ...
                    {#if requiereJustificacionIndustria4}
                        ...
                        <Textarea
                            ...
                            required={!requiereJustificacionIndustria4
                                ? undefined
                                : 'required'}
                        />
                    {/if}
            ...
            <div class="mt-44 grid grid-cols-2">
                <div>
                    <Label
                        labelFor="justificacion_economia_naranja"
                ...
                <div>
                    <div class="flex items-center mb-14">
                        <Switch
                            bind:checked={requiereJustificacionEconomiaNaranja}
                        />
                    </div>
                    {#if requiereJustificacionEconomiaNaranja}
                        ...
                        <Textarea
                            ...
                            bind:value={$form.justificacion_economia_naranja}
                            required={!requiereJustificacionEconomiaNaranja
                                ? undefined
                                : 'required'}
                        />
                    {/if}
            ...
            <div class="mt-44 grid grid-cols-2">
                ...
                <div>
                    <div class="flex items-center mb-14">
                        <Switch
                            bind:checked={requiereJustificacionPoliticaDiscapacidad}
                        />
                    </div>
                    ...
                    <div class="flex mb-20">
                        ...
                        <div class="bg-gray-300 flex-1 p-8">
                            ...
                            <div class="flex mt-4 items-center">
                                <FormField>
                                    <Radio
                                        bind:group={$form.objetivo_muestreo}
                                        value="1.2.1"
                                    />
                                    <span slot="label">
                    ...
                    <div class="grid grid-cols-2">
                        ...
                        >
                            {#each mesasSectoriales as { id, nombre }, i}
                                <FormField>
                                    <Checkbox
                                        bind:group={$form.mesa_sectorial_id}
                                        value={id}
                                    />
            ...
            {#if $form.relacionado_tecnoacademia?.value == 1}
                <div class="bg-indigo-100 p-5 mt-10">
                    ...
                    <div class="grid grid-cols-2">
                        ...
                        <div>
                            <Select
                                items={tecnoacademias}
                                id="tecnoacademia_id"
                                bind:selectedValue={$form.tecnoacademia_id}
                                error={errors.tecnoacademia_id}
                                autocomplete="off"
                                placeholder="Seleccione una opción"
                                required
                            />
                                ...
                                >
                                    {#each lineasTecnologicas as { id, nombre }, i}
                                        ...
                                        >
                                            <input
                                                type="checkbox"
                                                bind:group={$form.linea_tecnologica_id}
                                                {id}
                                                value={id}
            ...
            <div class="mt-44 grid grid-cols-2">
                ...
                <div>
                    <SelectMulti
                        id=""
                        bind:selectedValue={$form.municipios}
                        items={municipios}
                        isMulti={true}
            ...
            <div class="mt-44 grid grid-cols-1">
                ...
                <div>
                    <Textarea
                        ...
                        error={errors.impacto_municipios}
                        bind:value={$form.impacto_municipios}
                        required
                    />
                </div>
            </div>
