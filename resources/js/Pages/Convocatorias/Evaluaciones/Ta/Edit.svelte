<script>
    ...
    function submit() {
        if (isSuperAdmin || (checkRole(authUser, [11]) && ta.taEvaluacion.evaluacion.finalizado == false && taEvaluacion.evaluacion.habilitado == true && taEvaluacion.evaluacion.modificable == true)) {
