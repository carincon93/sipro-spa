<script>
    ...
    function submit() {
        if (isSuperAdmin || (checkRole(authUser, [11]) && idi.idiEvaluacion.evaluacion.finalizado == false && idiEvaluacion.evaluacion.habilitado == true && idiEvaluacion.evaluacion.modificable == true)) {
