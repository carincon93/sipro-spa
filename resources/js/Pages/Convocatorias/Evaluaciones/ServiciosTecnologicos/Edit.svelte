                ...
                {#if servicioTecnologico.proyecto.pdf_versiones}
                    ...
                    <ul>
                        {#each servicioTecnologico.proyecto.pdf_versiones as version}
                            <li>
                                {#if version.estado == 1}
                                    <a class="text-white underline" href={route('convocatorias.proyectos.version', [convocatoria.id, servicioTecnologico.id, version.version])}> {version.version}.pdf - Descargar</a>
