                ...
                <div class="p-8">
                    ...
                    {#if presupuestoInfo.codigo_uso_presupuestal == '2010100600203101'}
                        <div class="mt-4">
                            ...
                            <select disabled id="tipo_licencia" class="w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50 focus:border-violet-200 focus:ring-violet-200 p-4" value={presupuestoInfo.tipo_licencia}>
                        ...
                        <div class="mt-4">
                            ...
                            <select disabled id="tipo_software" class="w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50 focus:border-violet-200 focus:ring-violet-200 p-4" value={presupuestoInfo.tipo_software}>
