<script>
    ...
    let canEditProjectTypes =
        ...
        'project-types.edit'
    let canDestroyProjectTypes =
        authUser.can.find((element) => element == 'project-types.destroy') ==
    ...
    function destroy() {
        if (canDestroyProjectTypes || isSuperAdmin) {
...
<AuthenticatedLayout>
    <header class="shadow bg-white" slot="header">
        ...
        >
            <div>
                <h1>
                    {#if canIndexProjectTypes || canShowProjectTypes || canEditProjectTypes || canDestroyProjectTypes || isSuperAdmin}
                        <a
                            use:inertia
