...
<div class={$$restProps.class}>
    ...
    <div>
        {#if route || valueDb}
            <a href={route || valueDb} target="_blank" class="flex items-center justify-center hover:bg-cyan-100 bg-cyan-200 delay-100 text-cyan-500 p-2 rounded shadow-lg mb-2 text-xs">
