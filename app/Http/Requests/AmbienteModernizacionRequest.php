...
class AmbienteModernizacionRequest extends FormRequest
{
    ...
    public function rules()
    {
        if ($this->isMethod('PUT')) {
            return [
                'codigo_proyecto_sgps_id'               => ['required', 'min:0', 'max:2147483647', 'integer', 'exists:codigos_proyectos_sgps,id'],
                ...
                'mesa_sectorial_id*'                    => ['nullable', 'min:0', 'max:2147483647', 'exists:mesas_sectoriales,id'],
                'tipologia_ambiente_id'                 => ['required', 'min:0', 'max:2147483647', 'integer', 'exists:tipologias_ambientes,id'],
                'codigos_proyectos_id'                  => ['required_if:financiado_anteriormente,1', 'nullable'],
                'programas_formacion_calificados'       => ['required_if:ambiente_activo,1', 'nullable', 'min:0', 'max:2147483647', 'integer', 'exists:programas_formacion,id'],
                'programas_formacion'                   => ['required_if:ambiente_activo,1', 'nullable', 'min:0', 'max:2147483647', 'integer', 'exists:programas_formacion_articulados,id'],
                ...
                'estado_general_maquinaria'             => ['required', 'integer', 'min:0', 'max:2147483647'],
                ...
                'numero_personas_certificadas'          => ['required_if:ambiente_formacion_complementaria,1', 'nullable', 'integer', 'min:0', 'max:2147483647'],
                'numero_tecnicas_tecnologias'           => ['required', 'integer', 'min:0', 'max:2147483647'],
                'numero_publicaciones'                  => ['required', 'integer', 'min:0', 'max:2147483647'],
                'numero_aprendices_beneficiados'        => ['required', 'integer', 'min:0', 'max:2147483647'],
            ...
            return [
                ...
                'disciplina_subarea_conocimiento_id'    => ['required', 'min:0', 'max:2147483647', 'integer', 'exists:disciplinas_subarea_conocimiento,id'],
                'tematica_estrategica_id'               => ['required', 'min:0', 'max:2147483647', 'integer', 'exists:tematicas_estrategicas,id'],
                'mesa_sectorial_id*'                    => ['nullable', 'min:0', 'max:2147483647', 'integer', 'exists:mesas_sectoriales,id'],
                'tipologia_ambiente_id'                 => ['required', 'min:0', 'max:2147483647', 'integer', 'exists:tipologias_ambientes,id'],
