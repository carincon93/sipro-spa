    ...
    public function rules()
    {
        if ($this->isMethod('PUT')) {
            return [
                ...
                'municipios_impactar*'                      => ['required', 'integer', 'min:0', 'max:2147483647', 'exists:municipios,id'],
                'programas_formacion_articulados*'          => ['required', 'integer', 'min:0', 'max:2147483647', 'exists:programas_formacion,id'],
                'dis_curricular_id*'                        => ['required', 'integer', 'min:0', 'max:2147483647', 'exists:dis_curriculares,id'],
