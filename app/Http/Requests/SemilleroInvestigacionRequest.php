    ...
    public function rules()
    {
        if ($this->isMethod('PUT')) {
            return [
                ...
                'formato_gic_f_021'         => ['nullable', 'string', 'url'],
                'formato_gic_f_032'         => ['nullable', 'string', 'url'],
                'formato_aval_semillero'    => ['nullable', 'string', 'url'],
            ...
            return [
                ...
                'objetivo_general'          => ['required'],
                'link_semillero'            => ['nullable', 'url', 'string'],
                'formato_gic_f_021'         => ['required', 'string', 'url'],
                'formato_gic_f_032'         => ['required', 'string', 'url'],
                'formato_aval_semillero'    => ['required', 'string', 'url'],
                'redes_conocimiento'        => ['required'],
                'programas_formacion'       => ['required'],
                'lineas_investigacion'      => ['required'],
            ];
