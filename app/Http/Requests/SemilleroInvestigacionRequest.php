    ...
    public function rules()
    {
        if ($this->isMethod('PUT')) {
            return [
                ...
                'formato_gic_f_021'         => ['nullable', 'max:191', 'url'],
                'formato_gic_f_032'         => ['nullable', 'max:191', 'url'],
                'formato_aval_semillero'    => ['nullable', 'max:191', 'url'],
            ...
            return [
                ...
                'objetivo_general'          => ['required'],
                'link_semillero'            => ['nullable', 'url'],
                'formato_gic_f_021'         => ['required', 'max:191', 'url'],
                'formato_gic_f_032'         => ['required', 'max:191', 'url'],
                'formato_aval_semillero'    => ['required', 'max:191', 'url'],
                'redes_conocimiento'        => ['required'],
                'programas_formacion'       => ['required'],
                'lineas_investigacion'      => ['required'],
            ];
