...
class TaController extends Controller
{
    ...
    public function edit(Convocatoria $convocatoria, Ta $ta)
    {
        ...
        return Inertia::render('Convocatorias/Proyectos/Ta/Edit', [
            'convocatoria'                          => $convocatoria->only('id', 'esta_activa', 'fase_formateada', 'fase', 'tipo_convocatoria', 'min_fecha_inicio_proyectos_ta', 'max_fecha_finalizacion_proyectos_ta', 'fecha_maxima_ta', 'mostrar_recomendaciones'),
            'ta'                                    => $ta,
            ...
            'programasFormacion'                    => SelectHelper::programasFormacion()->where('centro_formacion_id', $ta->proyecto->centroFormacion->id)->values()->all(),
            'lineasTecnoacademia'                   => SelectHelper::lineasTecnoacademia(),
    ...
    public function showArticulacionSennova(Convocatoria $convocatoria, Proyecto $proyecto)
    {
        ...
        return Inertia::render('Convocatorias/Proyectos/ArticulacionSennova/Index', [
            ...
            'proyecto'                  => $proyecto->only('id', 'precio_proyecto', 'codigo_linea_programatica', 'proyectos_ejecucion', 'modificable', 'articulacion_semillero', 'semilleros_en_formalizacion', 'mostrar_recomendaciones', 'PdfVersiones', 'all_files'),
    ...
    public function showArticulacionSennovaEvaluacion(Convocatoria $convocatoria, Evaluacion $evaluacion)
    {
        ...
        return Inertia::render('Convocatorias/Evaluaciones/ArticulacionSennova/Index', [
            'convocatoria'              => $convocatoria->only('id', 'esta_activa', 'fase_formateada', 'fase', 'tipo_convocatoria', 'year', 'min_fecha_inicio_proyectos_ta', 'max_fecha_finalizacion_proyectos_ta', 'mostrar_recomendaciones'),
