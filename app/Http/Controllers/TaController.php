...
class TaController extends Controller
{
    ...
    public function create(Convocatoria $convocatoria)
    {
        ...
        return Inertia::render('Convocatorias/Proyectos/Ta/Create', [
            'convocatoria'   => $convocatoria->only('id', 'fase_formateada', 'fase', 'tipo_convocatoria', 'min_fecha_inicio_proyectos_ta', 'max_fecha_finalizacion_proyectos_ta', 'fecha_maxima_ta'),
    ...
    public function edit(Convocatoria $convocatoria, Ta $ta)
    {
        ...
        return Inertia::render('Convocatorias/Proyectos/Ta/Edit', [
            'convocatoria'                          => $convocatoria->only('id', 'fase_formateada', 'fase', 'tipo_convocatoria', 'min_fecha_inicio_proyectos_ta', 'max_fecha_finalizacion_proyectos_ta', 'fecha_maxima_ta', 'mostrar_recomendaciones'),
            'ta'                                    => $ta,
    ...
    public function showArticulacionSennova(Convocatoria $convocatoria, Proyecto $proyecto)
    {
        ...
        return Inertia::render('Convocatorias/Proyectos/ArticulacionSennova/Index', [
            'convocatoria'              => $convocatoria->only('id', 'fase_formateada', 'fase', 'tipo_convocatoria', 'year', 'min_fecha_inicio_proyectos_ta', 'max_fecha_finalizacion_proyectos_ta'),
    ...
    public function showArticulacionSennovaEvaluacion(Convocatoria $convocatoria, Evaluacion $evaluacion)
    {
        ...
        return Inertia::render('Convocatorias/Evaluaciones/ArticulacionSennova/Index', [
            'convocatoria'              => $convocatoria->only('id', 'fase_formateada', 'fase', 'tipo_convocatoria', 'year', 'min_fecha_inicio_proyectos_ta', 'max_fecha_finalizacion_proyectos_ta', 'mostrar_recomendaciones'),
