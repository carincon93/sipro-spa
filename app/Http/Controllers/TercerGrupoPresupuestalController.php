...
class TercerGrupoPresupuestalController extends Controller
{
    ...
    public function store(TercerGrupoPresupuestalRequest $request)
    {
        ...
        return redirect()->route('tercer-grupo-presupuestal.index')->with('success', 'The resource has been created successfully.');
    }
    ...
    public function destroy(TercerGrupoPresupuestal $tercerGrupoPresupuestal)
    {
        ...
        return redirect()->route('tercer-grupo-presupuestal.index')->with('success', 'The resource has been deleted successfully.');
    }
}
