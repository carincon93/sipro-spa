...
class SectorProductivoController extends Controller
{
    ...
    public function store(SectorProductivoRequest $request)
    {
        ...
        return redirect()->route('sectores-productivos.index')->with('success', 'The resource has been created successfully.');
    }
    ...
    public function destroy(SectorProductivo $sectorProductivo)
    {
        ...
        return redirect()->route('sectores-productivos.index')->with('success', 'The resource has been deleted successfully.');
    }
}
