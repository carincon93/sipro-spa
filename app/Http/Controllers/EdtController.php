...
class EdtController extends Controller
{
    ...
    public function index(Convocatoria $convocatoria, Proyecto $proyecto)
    {
        ...
        return Inertia::render('Convocatorias/Proyectos/EDT/Index', [
            ...
            'proyecto'         => $proyecto->only('id', 'codigo_linea_programatica', 'precio_proyecto', 'modificable', 'servicios_organizacion', 'evaluaciones', 'mostrar_recomendaciones', 'PdfVersiones', 'all_files'),
