...
class EvaluacionesExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithProperties, WithColumnFormatting
{
    ...
    public function map($evaluacion): array
    {
        return [
            ...
            $evaluacion->proyecto->idi()->exists() ? $evaluacion->proyecto->estado_evaluacion_idi['puntaje'] : ($evaluacion->proyecto->culturaInnovacion()->exists() ? $evaluacion->proyecto->estado_evaluacion_cultura_innovacion['puntaje'] : ($evaluacion->proyecto->ta()->exists() ? $evaluacion->proyecto->estado_evaluacion_ta['estado'] : ($evaluacion->proyecto->tp()->exists() ? $evaluacion->proyecto->estado_evaluacion_tp['estado'] : ($evaluacion->proyecto->servicioTecnologico()->exists() ? $evaluacion->proyecto->estado_evaluacion_servicios_tecnologicos['puntaje'] : 'Sin información registrada')))),
