...
class EvaluacionesExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithProperties, WithColumnFormatting
{
    ...
    public function map($evaluacion): array
    {
        return [
            ...
            $evaluacion->proyecto->idi()->exists() ? $evaluacion->proyecto->estadoEvaluacionIdi($evaluacion->getTotalEvaluacionAttribute(), $evaluacion->getTotalRecomendacionesAttribute(), null, $evaluacion->causal_rechazo_idi)['estado'] : ($evaluacion->proyecto->culturaInnovacion()->exists() ? $evaluacion->proyecto->estadoEvaluacionCulturaInnovacion($evaluacion->getTotalEvaluacionAttribute(), $evaluacion->getTotalRecomendacionesAttribute(), null)['estado'] : ($evaluacion->proyecto->ta()->exists() ? $evaluacion->proyecto->estado_evaluacion_ta['estado'] : ($evaluacion->proyecto->tp()->exists() ? $evaluacion->proyecto->estado_evaluacion_tp['estado'] : ($evaluacion->proyecto->servicioTecnologico()->exists() ? $evaluacion->proyecto->estadoEvaluacionServiciosTecnologicos($evaluacion->getTotalEvaluacionAttribute(), $evaluacion->getTotalRecomendacionesAttribute(), null)['estado'] : 'Sin información registrada')))),
