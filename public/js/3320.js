/*! For license information please see 3320.js.LICENSE.txt */
        ...
        93320: (e, t, n) => {
            ...
            function L(e) {
                ...
                return {
                    c() {
                        ;(t = (0, a.bG)('h1')),
                            (t.textContent = 'Resultados de la búsqueda de programas de formación'),
                            (n = (0, a.Dh)()),
                            (0, a.YC)(s.$$.fragment),
                            (i = (0, a.Dh)()),
                            (r = (0, a.bG)('div')),
            ...
            function b(e) {
                ...
                const d = [g, y],
                    l = []
                function u(e, n) {
                    return 1 & n && (t = !!(e[7] || ((0, r.P_)(e[6], [1, 3, 4, 11, 12, 13]) && 1 == e[0].modificable))), t ? 0 : 1
                }
                return (
                    (n = u(e, -1)),
                    (s = l[n] = d[n](e)),
            ...
            function k(e, t) {
                let n,
                    ...
                    H = t[21].nombre + '',
                    $ = t[21].modalidad + '',
                    I = t[21].centro_formacion.nombre + '',
                    j = t[21].centro_formacion.regional.nombre + ''
                return (
                    (w = new c.Z({ props: { class: t[1].length < 4 ? 'z-50' : '', $$slots: { default: [b] }, $$scope: { ctx: t } } })),
                    {
                        key: e,
                        first: null,
                        c() {
                            ;(n = (0, a.bG)('tr')),
                                ...
                                (0, a.Lj)(L, 'class', 'px-6 py-4'),
                                (0, a.Lj)(M, 'class', 'border-t'),
                                (0, a.Lj)(T, 'class', 'px-6 py-4'),
                                (0, a.Lj)(Y, 'class', 'border-t'),
                                (0, a.Lj)(k, 'class', 'border-t td-actions'),
                        ...
                        p(e, n) {
                            ;(t = e),
                                (!S || 2 & n) && x !== (x = t[21].codigo + '') && (0, a.rT)(r, x),
                                (!S || 2 & n) && H !== (H = t[21].nombre + '') && (0, a.rT)(u, H),
                                (!S || 2 & n) && $ !== ($ = t[21].modalidad + '') && (0, a.rT)(f, $),
                                (!S || 2 & n) && I !== (I = t[21].centro_formacion.nombre + '') && (0, a.rT)(y, I),
                                (!S || 2 & n) && j !== (j = t[21].centro_formacion.regional.nombre + '') && (0, a.rT)(v, j)
                            const s = {}
                            2 & n && (s.class = t[1].length < 4 ? 'z-50' : ''), 16777219 & n && (s.$$scope = { dirty: n, ctx: t }), w.$set(s)
                        },
                        i(e) {
                            S || ((0, a.Ui)(w.$$.fragment, e), (S = !0))
                        },
                        o(e) {
                            ;(0, a.et)(w.$$.fragment, e), (S = !1)
                        },
                        d(e) {
                            e && (0, a.og)(n), (0, a.vp)(w)
                        },
            ...
            function w(e) {
                ...
                return {
                    c() {
                        ;(t = (0, a.bG)('tr')), (n = (0, a.bG)('td')), (s = (0, a.fL)(i)), (0, a.Lj)(n, 'class', 'border-t px-6 py-4'), (0, a.Lj)(n, 'colspan', '6')
                    },
                    m(e, i) {
            ...
            function x(e) {
                let t, n
                return (
                    (t = new h.xv({ props: { $$slots: { default: [S] }, $$scope: { ctx: e } } })),
                    {
                        c() {
                            ;(0, a.YC)(t.$$.fragment)
                        },
            ...
            function H(e) {
                let t, n
                return (
                    (t = new h.ck({ props: { $$slots: { default: [x] }, $$scope: { ctx: e } } })),
                    t.$on('SMUI:action', function () {
                        return e[16](e[18])
                    }),
                    {
            ...
            function $(e, t) {
                let n,
                    ...
                    x = t[18].nombre + '',
                    $ = t[18].modalidad + '',
                    I = t[18].centro_formacion.nombre + '',
                    j = t[18].centro_formacion.regional.nombre + ''
                return (
                    (k = new c.Z({ props: { class: t[0].programasFormacion.length < 4 ? 'z-50' : '', $$slots: { default: [H] }, $$scope: { ctx: t } } })),
                    {
                        key: e,
                        first: null,
                        c() {
                            ;(n = (0, a.bG)('tr')),
                                ...
                                (0, a.Lj)(T, 'class', 'px-6 py-4'),
                                (0, a.Lj)(Y, 'class', 'border-t'),
                                (0, a.Lj)(b, 'class', 'border-t td-actions'),
                                (0, a.Lj)(n, 'class', 'hover:bg-gray-100 focus-within:bg-gray-100'),
                                (this.first = n)
                        },
                        m(e, t) {
                        ...
                        p(e, n) {
                            ;(t = e),
                                (!w || 1 & n) && S !== (S = t[18].codigo + '') && (0, a.rT)(r, S),
                                (!w || 1 & n) && x !== (x = t[18].nombre + '') && (0, a.rT)(u, x),
                                (!w || 1 & n) && $ !== ($ = t[18].modalidad + '') && (0, a.rT)(f, $),
                                (!w || 1 & n) && I !== (I = t[18].centro_formacion.nombre + '') && (0, a.rT)(y, I),
                                (!w || 1 & n) && j !== (j = t[18].centro_formacion.regional.nombre + '') && (0, a.rT)(v, j)
                            const s = {}
                            1 & n && (s.class = t[0].programasFormacion.length < 4 ? 'z-50' : ''), 16777217 & n && (s.$$scope = { dirty: n, ctx: t }), k.$set(s)
                        },
                        i(e) {
                            w || ((0, a.Ui)(k.$$.fragment, e), (w = !0))
                        },
                        o(e) {
                            ;(0, a.et)(k.$$.fragment, e), (w = !1)
                        },
                        d(e) {
                            e && (0, a.og)(n), (0, a.vp)(k)
                        },
            ...
            function j(e) {
                ...
                let F = { label: 'Escriba el ID o el nombre completo del programa de formación', id: 'search_programa_formacion', type: 'search', class: 'mt-1 m-auto block flex-1', input$minLength: '4', autocomplete: 'off', required: !0 }
                void 0 !== e[4].search_programa_formacion && (F.value = e[4].search_programa_formacion), (m = new u.Z({ props: F })), a.Vn.push(() => (0, a.ak)(m, 'value', P)), (y = new _.Z({ props: { loading: e[2], class: 'btn-indigo m-auto ml-1', type: 'submit', $$slots: { default: [M] }, $$scope: { ctx: e } } }))
                let R = e[3] && L(e),
                    N = e[0].programasFormacion
                const W = (e) => e[18].id
                ...
                let U = 0 === e[0].programasFormacion.length && I(e)
                return {
                    c() {
                        ;(t = (0, a.bG)('div')),
                            (n = (0, a.bG)('h1')),
                            (n.textContent = 'Programas de formación'),
                            (s = (0, a.Dh)()),
                            (i = (0, a.bG)('p')),
                            (i.textContent = 'Realiza la búsqueda de programas de formación'),
                            (o = (0, a.Dh)()),
                            (d = (0, a.bG)('form')),
                            (l = (0, a.bG)('fieldset')),
                            (c = (0, a.bG)('div')),
                            ...
                            (T = (0, a.Dh)()),
                            (v = (0, a.bG)('h1')),
                            (v.textContent = 'Programas de formación vinculados'),
                            (D = (0, a.Dh)()),
                            (b = (0, a.bG)('div')),
                            (k = (0, a.bG)('table')),
                            (w = (0, a.bG)('thead')),
                        ...
                        ;(H = (0, a.Dh)()),
                            U && U.c(),
                            (0, a.Lj)(n, 'class', 'text-4xl text-center title'),
                            (0, a.Lj)(i, 'class', 'text-center w-1/3 m-auto mt-8'),
                            (0, a.Lj)(c, 'class', 'mt-4 flex flex-row'),
                            (l.disabled = g = !(e[7] || ((0, r.P_)(e[6], [1, 3, 4, 11, 12, 13]) && 1 == e[0].modificable)) || void 0),
                    ...
                    m(r, u) {
                        ;(0, a.$T)(r, t, u),
                            ...
                            (0, a.R3)(k, S),
                            (0, a.R3)(k, x)
                        for (let e = 0; e < O.length; e += 1) O[e].m(x, null)
                        ;(0, a.R3)(x, H), U && U.m(x, null), (j = !0), E || ((A = [(0, a.oL)(d, 'submit', (0, a.AT)(e[9])), (0, a.oL)(d, 'input', e[14])]), (E = !0))
                    },
                    p(e, [n]) {
                        const s = {}
                        !h && 16 & n && ((h = !0), (s.value = e[4].search_programa_formacion), (0, a.hj)(() => (h = !1))), m.$set(s)
                        const i = {}
                        4 & n && (i.loading = e[2]),
                            16777216 & n && (i.$$scope = { dirty: n, ctx: e }),
                            y.$set(i),
                            (!j || (1 & n && g !== (g = !(e[7] || ((0, r.P_)(e[6], [1, 3, 4, 11, 12, 13]) && 1 == e[0].modificable)) || void 0))) && (l.disabled = g),
                            e[3]
                                ? R
                                ...
                                : R &&
                                  ...
                                  (0, a.gb)()),
                            2049 & n && ((N = e[0].programasFormacion), (0, a.dv)(), (O = (0, a.GQ)(O, n, W, 1, e, N, C, x, a.cl, $, H, f)), (0, a.gb)()),
                            0 === e[0].programasFormacion.length ? (U ? U.p(e, n) : ((U = I(e)), U.c(), U.m(x, null))) : U && (U.d(1), (U = null))
                    },
                    i(e) {
                        if (!j) {
                            ;(0, a.Ui)(m.$$.fragment, e), (0, a.Ui)(y.$$.fragment, e), (0, a.Ui)(R)
                            for (let e = 0; e < N.length; e += 1) (0, a.Ui)(O[e])
                            j = !0
                        }
                    },
                    o(e) {
                        ;(0, a.et)(m.$$.fragment, e), (0, a.et)(y.$$.fragment, e), (0, a.et)(R)
                        for (let e = 0; e < O.length; e += 1) (0, a.et)(O[e])
                        j = !1
                    },
                    d(e) {
            ...
            function E(e, t, n) {
                ...
                let { convocatoria: c } = t,
                    ...
                    f = d.props.auth.user,
                    p = (0, r.Zd)(f, [1]),
                    M = (0, i.cI)({ search_programa_formacion: '' })
                ;(0, a.FI)(e, M, (e) => n(4, (u = e)))
                let L = !1,
                    y = !1
                function g(e) {
                    ;(p || ((0, r.P_)(f, [1, 3, 4, 11, 12, 13]) && 1 == m.modificable)) && s.rC.post((0, r.BC)('convocatorias.proyectos.participantes.programas-formacion.link', { proyecto: m.id, convocatoria: c.id }), { programa_formacion_id: e }, { preserveScroll: !0 })
                }
                function Y(e) {
                    ;(p || ((0, r.P_)(f, [1, 3, 4, 11, 12, 13]) && 1 == m.modificable)) && s.rC.post((0, r.BC)('convocatorias.proyectos.participantes.programas-formacion.unlink', { proyecto: m.id, convocatoria: c.id }), { programa_formacion_id: e, _method: 'DELETE' }, { preserveScroll: !0 })
                }
                return (
                    (e.$$set = (e) => {
                    ...
                    [
                        ...
                        M,
                        function () {
                            if (p || ((0, r.P_)(f, [1, 3, 4, 11, 12, 13]) && 1 == m.modificable)) {
                                n(2, (L = !0)), n(3, (y = console.log('here')))
                                try {
                                    l()
                                        .post((0, r.BC)('convocatorias.proyectos.participantes.programas-formacion', { convocatoria: c.id, proyecto: m.id }), u)
                                        .then((e) => {
                        ...
                        c,
                        function (t) {
                            e.$$.not_equal(u.search_programa_formacion, t) && ((u.search_programa_formacion = t), M.set(u))
                        },
                        () => n(3, (y = !1)),
                        (e) => g(e.id),
                        (e) => Y(e.id),
            ...
            class A extends a.f_ {
                constructor(e) {
                    super(), (0, a.S1)(this, e, E, j, a.N8, { convocatoria: 12, proyecto: 0 })
                }
            }
            const O = A
        },
