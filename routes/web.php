...
Route::middleware(['auth', 'verified'])->group(function () {
     ...
     * 
     */
    Route::get('web-api/centros-formacion/{centro_formacion}/programas-formacion-articulados', function ($centroFormacion) {
        return response(ProgramaFormacion::selectRaw('id as value, concat(programas_formacion.nombre, chr(10), \'∙ Código: \', programas_formacion.codigo) as label')->where('centro_formacion_id', $centroFormacion)->whereIn('programas_formacion.codigo', [
